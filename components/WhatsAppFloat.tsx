  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {showTooltip && (
          ...
          >
            <button
              ...
              className="absolute top-2 right-2 text-gray-400 hover:text-gray-600 text-xs leading-none"
              aria-label="Close"
            >
              ✕
            </button>
            <p className="text-gray-800 text-xs font-semibold leading-relaxed pr-4">
              💬 Chat with Arjun for instant wedding photography quotes!
            </p>
      ...
      <a
        ...
        className="relative flex items-center justify-center w-16 h-16 rounded-full bg-green-500 hover:bg-green-400 shadow-2xl transition-all duration-200 hover:scale-110"
      >
        {/* Pulse rings */}
